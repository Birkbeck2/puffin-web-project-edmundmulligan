...
https://birkbeck2.github.io/puffin-web-project-edmundmulligan/ or the production version (which contains additional lessons and other content) can be viewed at 
...
\begin{itemize}
    ...
    \item Text read by students must be below college-level reading ability, to ensure that the content is accessible to a wide audience.
