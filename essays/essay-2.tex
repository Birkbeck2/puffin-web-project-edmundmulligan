...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{bewitched.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{jeannie.jpeg}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \label{fig:wand-faq}
    \end{subfigure}
    \caption{Wand icons from Font Awesome Pro used in Web Witchcraft and Wizardry \citep{fontawesome2026}}
    \label{fig:wands}
\end{figure}
